...
- Заканчивай ответ ОТКРЫТЫМ вопросом или фразой, которая приглашает к любому действию.
  Например: «Что ты будешь делать?», «Куда направишься?», «Твой ход.», «Как поступишь?»
